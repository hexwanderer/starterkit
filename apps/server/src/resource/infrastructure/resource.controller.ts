...
export const ResourceControllerSetup = new Elysia({
  prefix: "/resources",
}).decorate({
  repository: new ResourcePostgresImpl(db),
});

export function addResourceRoutes(app: typeof ResourceControllerSetup) {
  return app
...
export const ResourceController = addResourceRoutes(ResourceControllerSetup);
